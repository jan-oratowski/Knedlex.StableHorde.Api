...
namespace Knedlex.StableHorde.Api.Model
{
    ...
    public partial class RequestStatusCheck : IValidatableObject
    {
        /// <summary>
        ...
        public RequestStatusCheck(int finished = default(int), int processing = default(int), int restarted = default(int), int waiting = default(int), bool done = default(bool), bool faulted = false, int waitTime = default(int), int queuePosition = default(int), decimal kudos = default(decimal), bool isPossible = true)
        {
