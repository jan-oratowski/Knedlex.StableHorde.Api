...
namespace Knedlex.StableHorde.Api.Model
{
    ...
    public partial class ModelPayloadStable : IValidatableObject
    {
        /// <summary>
        /// Defines SamplerName
        /// </summary>
        ...
        public List<ModelPayloadStable.PostProcessingEnum> PostProcessing { get; set; }
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            if (this.CfgScale > (decimal)100)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for CfgScale, must be a value less than or equal to 100.", new [] { "CfgScale" });
            }
