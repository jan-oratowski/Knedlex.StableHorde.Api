...
namespace Knedlex.StableHorde.Api.Model
{
    ...
    public partial class RequestError : IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>The return code for this error. See: https://github.com/Haidra-Org/AI-Horde/blob/main/README_return_codes.md</value>
        /// <example>ExampleHordeError</example>
        ...
        public RequestError(string message = default(string), RcEnum rc = default(RcEnum))
        {
            this.Rc = rc;
