...
namespace Knedlex.StableHorde.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ModelGenerationInputKobold")]
    public partial class ModelGenerationInputKobold : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ModelGenerationInputKobold" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ModelGenerationInputKobold {\n");
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            if (this.RepPenSlope > (decimal)10)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for RepPenSlope, must be a value less than or equal to 10.", new [] { "RepPenSlope" });
            }
            ...
            if (this.SmoothingFactor > (decimal)10)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for SmoothingFactor, must be a value less than or equal to 10.", new [] { "SmoothingFactor" });
            }
