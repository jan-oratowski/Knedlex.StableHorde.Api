...
namespace StableHorde.Api.Model
{
    ...
    public partial class ModelPayloadRootStable : IEquatable<ModelPayloadRootStable>, IValidatableObject
    {
        /// <summary>
        /// Defines SamplerName
        /// </summary>
        ...
        public ModelPayloadRootStable(SamplerNameEnum? samplerName = SamplerNameEnum.KEuler, List<int> toggles = default(List<int>), decimal cfgScale = default(decimal), decimal denoisingStrength = default(decimal), string seed = default(string), int height = default(int), int width = default(int), int seedVariation = default(int), bool useGfpgan = default(bool), bool useRealEsrgan = default(bool), bool useLdsr = default(bool), bool useUpscaling = default(bool))
        {
        ...
        {
            return this.Equals(input as ModelPayloadRootStable);
        }

        /// <summary>
        /// Returns true if ModelPayloadRootStable instances are equal
        /// </summary>
        /// <param name="input">Instance of ModelPayloadRootStable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ModelPayloadRootStable input)
        {
            if (input == null)
            {
                return false;
