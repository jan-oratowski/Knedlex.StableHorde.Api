...
namespace StableHorde.Api.Model
{
    ...
    public partial class ModifyUserInput : IEquatable<ModifyUserInput>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ModifyUserInput);
        }

        /// <summary>
        /// Returns true if ModifyUserInput instances are equal
        /// </summary>
        /// <param name="input">Instance of ModifyUserInput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ModifyUserInput input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.Customizer == input.Customizer ||
                    this.Customizer.Equals(input.Customizer)
                ) && 
                (
                    this.Vpn == input.Vpn ||
                ...
                (
                    this.ResetSuspicion == input.ResetSuspicion ||
                    this.ResetSuspicion.Equals(input.ResetSuspicion)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.Customizer.GetHashCode();
                ...
                hashCode = (hashCode * 59) + this.ResetSuspicion.GetHashCode();
