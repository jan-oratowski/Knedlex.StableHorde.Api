...
namespace StableHorde.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "HordePerformanceStable_allOf")]
    public partial class HordePerformanceStableAllOf : IEquatable<HordePerformanceStableAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="HordePerformanceStableAllOf" /> class.
        /// </summary>
        ...
        public HordePerformanceStableAllOf(int queuedRequests = default(int), decimal queuedMegapixelsteps = default(decimal), decimal pastMinuteMegapixelsteps = default(decimal), int workerCount = default(int))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class HordePerformanceStableAllOf {\n");
        ...
        {
            return this.Equals(input as HordePerformanceStableAllOf);
        }

        /// <summary>
        /// Returns true if HordePerformanceStableAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of HordePerformanceStableAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HordePerformanceStableAllOf input)
        {
            if (input == null)
            {
                return false;
