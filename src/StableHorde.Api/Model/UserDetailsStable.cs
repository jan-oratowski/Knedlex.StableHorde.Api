...
namespace StableHorde.Api.Model
{
    ...
    /// UserDetailsStable
    /// </summary>
    [DataContract(Name = "UserDetailsStable")]
    public partial class UserDetailsStable : IEquatable<UserDetailsStable>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UserDetailsStable" /> class.
        /// </summary>
        ...
        public UserDetailsStable(string username = default(string), int id = default(int), decimal kudos = default(decimal), decimal evaluatingKudos = default(decimal), int concurrency = default(int), int workerInvited = default(int), bool moderator = default(bool), UserKudosDetails kudosDetails = default(UserKudosDetails), int workerCount = default(int), List<string> workerIds = default(List<string>), MonthlyKudos monthlyKudos = default(MonthlyKudos), bool trusted = default(bool), int suspicious = default(int), bool pseudonymous = default(bool), UsageDetailsStable usage = default(UsageDetailsStable), ContributionsDetailsStable contributions = default(ContributionsDetailsStable))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UserDetailsStable {\n");
        ...
        {
            return this.Equals(input as UserDetailsStable);
        }

        /// <summary>
        /// Returns true if UserDetailsStable instances are equal
        /// </summary>
        /// <param name="input">Instance of UserDetailsStable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserDetailsStable input)
        {
            if (input == null)
            {
                return false;
