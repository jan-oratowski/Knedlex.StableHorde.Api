...
namespace StableHorde.Api.Model
{
    ...
    public partial class ModelGenerationInputKobold : IEquatable<ModelGenerationInputKobold>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ModelGenerationInputKobold);
        }

        /// <summary>
        /// Returns true if ModelGenerationInputKobold instances are equal
        /// </summary>
        /// <param name="input">Instance of ModelGenerationInputKobold to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ModelGenerationInputKobold input)
        {
            if (input == null)
            {
                return false;
