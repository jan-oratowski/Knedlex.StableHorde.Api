...
namespace StableHorde.Api.Model
{
    ...
    /// PatchExistingFilter
    /// </summary>
    [DataContract(Name = "PatchExistingFilter")]
    public partial class PatchExistingFilter : IEquatable<PatchExistingFilter>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PatchExistingFilter" /> class.
        /// </summary>
        /// <param name="regex">The regex for this filter..</param>
        /// <param name="filterType">The integer defining this filter type..</param>
        ...
        public PatchExistingFilter(string regex = default(string), int filterType = default(int), string description = default(string), string replacement = "")
        {
            this.Regex = regex;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PatchExistingFilter {\n");
        ...
        {
            return this.Equals(input as PatchExistingFilter);
        }

        /// <summary>
        /// Returns true if PatchExistingFilter instances are equal
        /// </summary>
        /// <param name="input">Instance of PatchExistingFilter to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PatchExistingFilter input)
        {
            if (input == null)
            {
                return false;
