...
namespace StableHorde.Api.Model
{
    ...
    public partial class ModelGenerationInputStable : IEquatable<ModelGenerationInputStable>, IValidatableObject
    {
        ...
        public ModelGenerationInputStable(SamplerNameEnum? samplerName = SamplerNameEnum.KEuler, List<int> toggles = default(List<int>), decimal cfgScale = default(decimal), decimal denoisingStrength = default(decimal), string seed = default(string), int height = default(int), int width = default(int), int seedVariation = default(int), bool useGfpgan = default(bool), bool useRealEsrgan = default(bool), bool useLdsr = default(bool), bool useUpscaling = default(bool), int steps = default(int), int n = default(int))
        {
