...
namespace StableHorde.Api.Model
{
    ...
    /// RequestStatusKobold
    /// </summary>
    [DataContract(Name = "RequestStatusKobold")]
    public partial class RequestStatusKobold : IEquatable<RequestStatusKobold>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RequestStatusKobold" /> class.
        /// </summary>
        ...
        public RequestStatusKobold(int finished = default(int), int processing = default(int), int restarted = default(int), int waiting = default(int), bool done = default(bool), bool faulted = false, int waitTime = default(int), int queuePosition = default(int), decimal kudos = default(decimal), bool isPossible = true, List<GenerationKobold> generations = default(List<GenerationKobold>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RequestStatusKobold {\n");
        ...
        {
            return this.Equals(input as RequestStatusKobold);
        }

        /// <summary>
        /// Returns true if RequestStatusKobold instances are equal
        /// </summary>
        /// <param name="input">Instance of RequestStatusKobold to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RequestStatusKobold input)
        {
            if (input == null)
            {
                return false;
