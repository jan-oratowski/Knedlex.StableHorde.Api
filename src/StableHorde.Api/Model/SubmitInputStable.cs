...
namespace StableHorde.Api.Model
{
    ...
    public partial class SubmitInputStable : IEquatable<SubmitInputStable>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as SubmitInputStable);
        }

        /// <summary>
        /// Returns true if SubmitInputStable instances are equal
        /// </summary>
        /// <param name="input">Instance of SubmitInputStable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SubmitInputStable input)
        {
            if (input == null)
            {
                return false;
