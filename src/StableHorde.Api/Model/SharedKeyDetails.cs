...
namespace StableHorde.Api.Model
{
    ...
    public partial class SharedKeyDetails : IEquatable<SharedKeyDetails>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as SharedKeyDetails);
        }

        /// <summary>
        /// Returns true if SharedKeyDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of SharedKeyDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SharedKeyDetails input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.Utilized == input.Utilized ||
                    this.Utilized.Equals(input.Utilized)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.Utilized.GetHashCode();
